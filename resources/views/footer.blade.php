                ...
                <div class="col-lg-4 col-md-6 footer-about">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                        <a href="{{url('/')}}" class="navbar-brand">
                            <h1 class="m-0 text-white"><i class="fa fa-user-tie me-2"></i>AmLopez</h1>
                        </a>
                        <p class="mt-3 mb-4">¡Hola! Mi nombre es Amílcar López y soy un estudiante del tercer año en Ingeniería en sistema y redes informáticas de la universidad Gerardo Barrios</p>
                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-5 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">Guatajiagua, Morazán, El Salvador</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-primary me-2"></i>
                                <p class="mb-0">josueamilcar1013@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-primary me-2"></i>
                                <p class="mb-0">+503 7344-0004</p>
                            </div>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white" style="text-decoration: none;" href="https://www.ugb.edu.sv/" target="_blank">Universidad Gerardo Barrios || Programación computacional IV</a> 
                    </div>
                </div>
            </div>
        </div>
